...
style_mono_accent(
  ...
  text_font_google   = google_font("Leto", "300", "300i"),
  code_font_google   = google_font("Fira Mono"),
  base_font_size = "20px",
  text_font_size = "1.0rem",
  header_h1_font_size = "0.8rem",  
...
### Creation and comparison of <br> movie recommender models <br> with the recommenderlab R package

<div class="bottom">
<p> Alexander Simon </p>
<p> 2024-05-08 </p>
<p> Presentation available on RPubs </p>
</div>
...
- My overall goal was to learn more about recommender systems by creating and comparing recommender models using the recommenderlab R package
...
- As an extended goal, I also challenged myself to create this presentation in R, which I've never done before
...
A rating matrix has user IDs as rows, movie IDs (ie, items) as columns, and movie ratings as values
...
```{r evaluate-models-topn, highlight.output=1:2}
...
## Comparing models: evaluation of top recommendations (cont'd)
...
.green[MovieLens dataset available from https://grouplens.org/datasets/movielens/]